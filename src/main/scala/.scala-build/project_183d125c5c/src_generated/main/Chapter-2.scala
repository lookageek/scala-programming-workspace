...
object `Chapter-2` {
/*<script>*/// writing loops as tail recursions which compile down to loops without recursion call stack
...
object `Chapter-2_sc` {
  ...
  def main(args: Array[String]): Unit = {
    args$set(args)
    `Chapter-2`.hashCode() // hasCode to clear scalac warning about pure expression in statement position
  }
}
